...
<div class="content write program">
    ...
    <div class="write_contents">
        <div class="">
            ...
            <form class="form" name="fwrite" id="fwrite" action="<?php echo $action_url ?>"
                ...
                <input type="hidden" name="wr_12" value="기관">
                <?php
                $option = '';
                $option_hidden = '';
                if ($is_html) {
                ...
                <div class="select_group">
                    <div class="select_box">
                        ...
                        <ul class="list">
                            <?php foreach ($get_city_list as $iValue) { ?>
                                <li>
                                    <button type="button" class="item city"
                    ...
                    <div class="select_box">
                        ...
                        <button type="button" class="select_btn" <?php if ($write['wr_8'] === '전체' || !$write) {
                            echo "disabled";
                        } ?>>
                            <span class="current"><?php if ($write) {
                                    echo $write['wr_9'];
                    ...
                    <div class="select_box handicap">
                        ...
                        <ul class="list">
                            <li>
                                <button type="button" class="item" name="전체">전체</button>
                            </li>
