...
?>
<div class="content list welfare">
    <div class="list_top">
    ...
    <div class="list_search">
        ...
        <form action="<?php echo G5_BBS_URL; ?>/board.php" method="GET" class="select_group">
            <input type="hidden" name="bo_table" value="welfare">
    ...
    <?php echo newGetPaging(G5_IS_MOBILE ? $config['cf_mobile_pages'] : $config['cf_write_pages'], $page, $total_page, get_pretty_url($bo_table, '', $qstr.'&amp;page='), 'welfare', $add);?>
</div>
<script>
    function getList(){
        var ul_tag = $("#district");
