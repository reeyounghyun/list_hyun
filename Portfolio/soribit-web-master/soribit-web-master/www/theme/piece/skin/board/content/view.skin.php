...
<div class="content view contents">
    ...
    <div class="view_contents">
        ...
        <?php if($view['link'][1] != ''){?>
        <a href="<?php echo $fetch_og['url']?>" class="youtube" target="_blank">
            <div class="youtube_image" style="background-image: url('<?php echo $fetch_og['image']?>');"></div>
            <div class="youtube_text">
                <p class="youtube_title"><?php echo $fetch_og['title']?></p>
                <p class="youtube_link"><?php echo $view['link'][1]?></p>
            </div>
        </a>
        <?php }?>
    </div>
...
<section>
    ...
    <div class="layer layer_report is-hidden">
        <div class="inner">
            ...
            <div class="btn_group">
                <button type="button" class="button color purple" onclick="location.href='<?php echo G5_THEME_URL.'/skin/board/content/update_report.php?bo_table=content&postid='.$view['wr_id'].'&memberid='.$member['mb_id'].'&reason='.'불건전'?>'">불건전</button>
                <button type="button" class="button color purple" onclick="location.href='<?php echo G5_THEME_URL.'/skin/board/content/update_report.php?bo_table=content&postid='.$view['wr_id'].'&memberid='.$member['mb_id'].'&reason='.'홍보성'?>'">홍보성</button>
                <button type="button" class="button color purple" onclick="location.href='<?php echo G5_THEME_URL.'/skin/board/content/update_report.php?bo_table=content&postid='.$view['wr_id'].'&memberid='.$member['mb_id'].'&reason='.'기타'?>'">기타</button>
