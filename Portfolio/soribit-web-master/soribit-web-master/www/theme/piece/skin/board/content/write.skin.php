            ...
            <form class="form" name="fwrite" id="fwrite" action="<?php echo $action_url ?>"
                ...
                <div class="select_box">
                    ...
                    <button type="button" class="select_btn">
                        <span class="current"><?php if(!$write){ echo "카테고리";} else { echo $write['ca_name'];}?></span>
                    </button>
                    <ul class="list">
                ...
                <input type="text" id="user-link" class="input-text" placeholder="콘텐츠 링크를 입력하세요" name="wr_link1" value="<?php echo $write['wr_link1']?>" >
