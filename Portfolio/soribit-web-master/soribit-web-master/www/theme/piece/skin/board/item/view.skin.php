...
$fetch_og = fetchOg(set_http($view['link'][1]));
?>
...
<div class="content view product">
    ...
    <div class="view_top">
        <?php $v_img_count = count($view['file']);?>
            <?php if($v_img_count === 0) {
                $image_path = G5_THEME_URL.'/pub/assets/images/product_thumbnail.png';
            }  else {
                $image_path = $view['file'][0]['path'].'/'.$view['file'][0]['file'];
            }?>
            <div class="image" style="background-image: url('<?php echo $image_path; ?>');"></div>
        <div class="text">
            <div class="title">
                <p><?php echo cut_str(get_text($view['wr_subject']), 70);  //글제목 출력 ?></p>
                <span class="service"><?php echo $view['ca_name'] ?></span>
            </div>
            <p class="category"><?php echo $view['wr_8'] ?></p>
        </div>
        <div class="date_wrap">
            <p class="date"><?php echo $view['datetime']?></p>
            <p class="view_count">조회수 <?php echo $view['wr_hit']?></p>
        </div>
    </div>
        <div class="view_contents">
            ...
            <?php if($view['link'][1] != ''){
                ?>
            <a href="outlink:<?php echo $view['link'][1];?>" class="youtube" target="_blank">
                ...
                <div class="youtube_text">
                    ...
                    <p class="youtube_link"><?php echo set_http($view['link'][1])?></p>
                </div>
            </a>
            <?php } ?>
        </div>
