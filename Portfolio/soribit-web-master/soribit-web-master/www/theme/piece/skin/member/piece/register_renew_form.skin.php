...
<?php } ?>
	...
	<?php if (isset($member['mb_nick_date']) && $member['mb_nick_date'] > date("Y-m-d", G5_SERVER_TIME - ($config['cf_nick_modify'] * 86400))) { // 닉네임수정일이 지나지 않았다면  ?>
        ...
        <input type="hidden" name="mb_email" value="<?php echo $member['mb_email']?>"/>
        ...
        <div class="id_wrap">
            ...
            <input type="hidden" id="reg_mb_name" name="mb_name" value="<?php echo get_text($member['mb_name']) ?>" <?php echo $required ?> <?php echo $readonly; ?> class="frm_input full_input input-text input_name is-checked <?php echo $required ?> <?php echo $readonly ?>" size="10" placeholder="이름">
            <input type="hidden" name="mb_nick" value="<?php echo $member['mb_nick']?>" id="reg_mb_nick" required class="frm_input required nospace full_input">
            <div class="number_wrap">
                <?// php echo get_text($member['mb_tel']) ?>
                <input type="text" name="mb_tel" value="" <?php echo $required ?> id="reg_mb_tel" <?php echo $config['cf_req_tel']?"required":""; ?> class="frm_input full_input input-text is-checked <?php echo $config['cf_req_tel']?"required":""; ?>" maxlength="20" placeholder="연락처">
            ...
            <input type="file" class="input_file" value="<?php echo $member['mb_2']?>" name="mb_2" id="mb_2" accept=".pdf, .jpg, .jpeg, .png">
                <div class="file_box">
                    <?php if($member['mb_2'] != '' & $member['mb_1'] == 0){ ?>
                    <button type="button" class="delete_file on" onclick="location.href='<?php echo G5_BBS_URL.'/delete_upload.php?mb_id='.$member['mb_id']?>'">
	...
	<div class="">
        ...
        <!-- disabled  -->
	    <button type="submit" id="btn_submit" class="btn_submit btn_next" accesskey="s" ><?php echo $w==''?'완료':'완료'; ?></button>
	</div>
	</form>
</div>
<script>
