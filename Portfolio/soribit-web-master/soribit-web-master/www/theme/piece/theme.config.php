...
$theme_config = array(
    ...
    'preview_board_skin'        => 'piece', // 테마 미리보기 때 적용될 기본 게시판 스킨
    'preview_mobile_board_skin' => 'piece', // 테마 미리보기 때 적용될 기본 모바일 게시판 스킨
    'cf_member_skin'            => 'piece', // 회원 스킨
    'cf_mobile_member_skin'     => 'piece', // 모바일 회원 스킨
    'cf_new_skin'               => 'piece', // 최근게시물 스킨
    'cf_mobile_new_skin'        => 'piece', // 모바일 최근게시물 스킨
    'cf_search_skin'            => 'piece', // 검색 스킨
    'cf_mobile_search_skin'     => 'piece', // 모바일 검색 스킨
    'cf_connect_skin'           => 'piece', // 접속자 스킨
    'cf_mobile_connect_skin'    => 'piece', // 모바일 접속자 스킨
    'cf_faq_skin'               => 'piece', // FAQ 스킨
    'cf_mobile_faq_skin'        => 'piece', // 모바일 FAQ 스킨
    ...
    'qa_skin'                   => 'piece', // 1:1문의 스킨
    'qa_mobile_skin'            => 'piece'  // 1:1문의 모바일 스킨
);
