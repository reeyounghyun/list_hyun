...
class HTMLPurifier_EntityLookup
{
    ...
    /**
     * Sets up the entity lookup table from the serialized file content.
     * @param bool $file
     * @note The serialized content are versioned, but were generated
...
class HTMLPurifier_EntityParser
{
    ...
    /**
     * Substitute entities with the parsed equivalents.  Use this on
     * attribute content in documents.
     *
     * @param string $string String to have entities parsed.
     * @return string Parsed string.
     */
...
class HTMLPurifier_Generator
{
    ...
    public function generateFromTokens($tokens)
    {
        ...
        for ($i = 0, $size = count($tokens); $i < $size; $i++) {
            if ($this->_scriptFix && $tokens[$i]->name === 'script'
                ...
                // script special case
                // the content of the script block must be ONE token
                // for this to work.
    ...
    /**
     * Special case processor for the content of script tags
     * @param HTMLPurifier_Token $token HTMLPurifier_Token object.
     * @return string
     * @warning This runs into problems if there's already a literal
     *          --> somewhere inside the script content.
     */
...
class HTMLPurifier_HTMLModule
{
    ...
    public function addElement($element, $type, $contents, $attr_includes = array(), $attr = array())
    {
        ...
        // literal object $content means direct child manipulation
    ...
    /**
     * Convenience function that transforms single-string content
     * into separate content model and content model type
     * @param string $contents Allowed children in form of:
     *                  "$content_model_type: $content_model"
     * @return array
     * @note If content is an object, an array of two nulls will be
     *       returned, and the callee needs to take the original $content
     *       and use it directly.
     */
...
class HTMLPurifier_LanguageFactory
{
    ...
    /**
     * Keys whose content are a hash map and can be merged.
     * @type array
     */
    protected $mergeable_keys_map = array('messages' => true, 'errorNames' => true);

    /**
     * Keys whose content are a list and can be merged.
     * @value array lookup
     */
...
class HTMLPurifier_Zipper
{
     ...
     * @return Original content of new hole.
     */
     ...
     * @return Original content of new hole, i away
     */
    ...
    /**
     * Delete content of current hole, shifting hole to
     * next element.
     * @return Original content of new hole.
     */
...
/**
 * Validates content based on NMTOKENS attribute type.
 */
...
/**
 * Takes the content of blockquote when in strict and reformats for validation.
 */
...
class HTMLPurifier_HTMLModule_Scripting extends HTMLPurifier_HTMLModule
{
    ...
    public function setup($config)
    {
        ...
        // blockquote's content are optional while noscript's content
        // are required)
...
class HTMLPurifier_Injector_RemoveEmpty extends HTMLPurifier_Injector
{
    ...
    /**
     * Cached content of %AutoFormat.RemoveEmpty.Predicate
     * @type array
     */
    private $exclude;
...
class HTMLPurifier_Lexer_DirectLex extends HTMLPurifier_Lexer
{
     ...
     * @param array $matches, in form of array(opening tag, content, closing tag)
     * @return string
     */
                ...
                if ($result === true) {
                    ...
                    if ($e) {
                        ...
                        if (empty($result) && !empty($children)) {
                            $e->send(E_ERROR, 'Strategy_FixNesting: Node content removed');
...
class HTMLPurifier_Strategy_RemoveForeignElements extends HTMLPurifier_Strategy
{
    ...
    public function execute($tokens, $config, $context)
    {
        ...
        // remove script content compatibility
