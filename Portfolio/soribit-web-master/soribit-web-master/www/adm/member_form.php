...
//인증
$mb_1_yes        =  $mb['mb_1']==1       ? 'checked="checked"' : '';
$mb_2_yes        =  $mb['mb_1']==2       ? 'checked="checked"' : '';
$mb_3_yes        =  $mb['mb_1']==3       ? 'checked="checked"' : '';
$mb_4_yes        =  $mb['mb_1']==4       ? 'checked="checked"' : '';

$mb_1_no         = !$mb['mb_1']       ? 'checked="checked"' : '';
...
this.form.mb_intercept_date.value=this.form.mb_intercept_date.defaultValue; }">
    ...
    ?>
        ...
        <tr>
            ...
            <td>
                <label for="mb_1_yes">장애인</label>
                <input type="radio" name="mb_1" value="1" id="mb_1_yes"  <?php echo $mb_1_yes; ?>>

                <label for="mb_2_yes">보호자</label>
                <input type="radio" name="mb_1" value="2" id="mb_2_yes"  <?php echo $mb_2_yes; ?>>

                <label for="mb_3_yes">기업</label>
                <input type="radio" name="mb_1" value="3" id="mb_3_yes"  <?php echo $mb_3_yes; ?>>

                <label for="mb_4_yes">기관</label>
                <input type="radio" name="mb_1" value="4" id="mb_4_yes"  <?php echo $mb_4_yes; ?>>

                <label for="mb_1_no">일반</label>
                <input type="radio" name="mb_1" value="0" id="mb_1_no"  <?php echo $mb_1_no; ?>>
            </td>
        </tr>
        <tr>
            <th scope="row">장애인등록증/사업자등록증 인증</th>
            <td>
                <input type="hidden" name="mb_2" value="<?php echo $mb['mb_2']?>">
                <?php if($mb['mb_2']){ ?>
                    <a href="<?php echo G5_DATA_URL.'/member/'.$mb['mb_2']?>" download>이미지 원본 다운로드</a>
                    <img src="<?php echo G5_DATA_URL.'/member/'.$mb['mb_2']?>" alt="" width="100%">
                <?php }?>
        </tr>
...
<div class="btn_fixed_top">
    <a href="./member_grade_management.php?<?php echo $qstr ?>" class="btn btn_02">목록</a>
