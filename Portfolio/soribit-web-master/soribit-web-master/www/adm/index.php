...
$colspan = 12;
//일일방문자
$get_visit_count = getVisitCount();
//일일 회원 가입 수
$get_joined_count = getJoinedCount();
//최근회원 가입 수(1주일)
$get_week_joined_count = getWeekJoinedCount();
?>
    <h2>피스</h2>
    <div class="num_list">
        <div class="num_box visit">
            <p>일일 방문자</p>
            <h3><?php echo number_format($get_visit_count); ?>명</h3>
        </div>
        <div class="num_box join">
            <p>일일회원 가입 수</p>
            <h3><?php echo number_format($get_joined_count); ?>명</h3>
        </div>
        <div class="num_box recent">
            <p>최근회원 가입 수</p>
            <h3><?php echo number_format($get_joined_count); ?>명</h3>
        </div>
        <div class="num_box total">
            <p>총 회원 수</p>
            <h3><?php echo number_format($total_count) ?>명</h3>
        </div>
        <div class="num_box doc">
            <p></p>
            <h3><?php ?>개</h3>
        </div>
        <div class="num_box pro">
            <p></p>
            <h3><?php ?>개</h3>
        </div>
        <div class="num_box device">
            <p></p>
            <h3><?php ?>개</h3>
        </div>
        <div class="num_box user">
            <p></p>
            <h3><?php ?>개</h3>
        </div>
        <div class="num_box project">
            <p></p>
            <h3><?php ?>개</h3>
        </div>
        <div class="num_box done">
            <p></p>
            <h3><?php ?>개</h3>
        </div>
    </div>
