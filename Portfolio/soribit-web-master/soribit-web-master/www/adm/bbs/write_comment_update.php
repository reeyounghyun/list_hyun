<?php
/**************************
@Filename: write_comment_update.php
@Version : 1.0
@Author  : Freemaster
...
if ($w == 'c') // 댓글 입력
{
    ...
    */
    ...
    if ($config['cf_email_use'] && $board['bo_use_email'])
    {
        ...
        $link_url = G5_ADMIN_BBS_URL."/board.php?bo_table=".$bo_table."&amp;wr_id=".$wr_id."&amp;".$qstr."#c_".$comment_id;
...
goto_url(G5_ADMIN_HTTP_BBS_URL.'/board.php?bo_table='.$bo_table.'&amp;wr_id='.$wr['wr_parent'].'&amp;'.$qstr.'&amp;#c_'.$comment_id);
?>
