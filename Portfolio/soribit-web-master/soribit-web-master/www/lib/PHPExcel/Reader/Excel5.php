...
class PHPExcel_Reader_Excel5 extends PHPExcel_Reader_Abstract implements PHPExcel_Reader_IReader
{
    ...
    /**
     * The position in the stream after which content are encrypted
     *
     * @var int
     */
...
//        echo '<br />';
     ...
     * file. All record content following this record will be
     * encrypted.
     *
     ...
     *
     * @return string The string content as UTF-8
     */
